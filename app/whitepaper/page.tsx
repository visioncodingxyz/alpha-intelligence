...
import { Home, FileText, Zap, Users, Target, Rocket, Menu, X } from 'lucide-react'
import Link from "next/link"

const sections = [
  { id: "introduction", title: "Introduction", icon: FileText },
  { id: "features", title: "AI Features", icon: Zap },
  { id: "tokenomics", title: "Tokenomics", icon: Target },
    ...
    <div className="h-screen bg-background text-foreground flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full">
        <div className="hidden lg:flex justify-between items-center p-4 border-b border-border/30 flex-shrink-0 h-[73px]">
          <h3 className="text-lg font-mono uppercase tracking-wide">ALPHA INTELLIGENCE WHITEPAPER</h3>
        </div>
                ...
                >
                  <div className="space-y-4 sm:space-y-6">
                    <p className="text-base sm:text-lg font-mono leading-relaxed">
                      ALPHA INTELLIGENCE IS A REVOLUTIONARY AI-POWERED PLATFORM ON THE SOLANA BLOCKCHAIN DESIGNED TO EMPOWER CREATORS, ARTISTS, AND INNOVATORS WITH CUTTING-EDGE ARTIFICIAL INTELLIGENCE.
                    </p>
                    <p className="font-mono text-sm sm:text-base leading-relaxed">
                      OUR PLATFORM COMBINES THE POWER OF ADVANCED AI MODELS WITH THE SPEED AND EFFICIENCY OF SOL TO CREATE THE MOST COMPREHENSIVE SUITE OF AI-POWERED CREATIVE TOOLS AVAILABLE.
                    </p>
                    <p className="font-mono text-sm sm:text-base leading-relaxed">
                      WITH $AI TOKEN AT ITS CORE, ALPHA INTELLIGENCE PROVIDES A DECENTRALIZED ECOSYSTEM WHERE USERS CAN
                      ACCESS PREMIUM AI TOOLS, PARTICIPATE IN GOVERNANCE, AND EARN REWARDS THROUGH STAKING AND COMMUNITY
                      PARTICIPATION.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      ...
                      <h3 className="text-lg sm:text-2xl font-mono uppercase text-primary tracking-wide">
                        INTELLIGENT AI CHATBOT
                      </h3>
                    </div>
                    <p className="font-mono text-sm sm:text-base leading-relaxed mb-3 sm:mb-4">
                      ENGAGE WITH OUR ADVANCED AI CHATBOT FOR CREATIVE ASSISTANCE, BRAINSTORMING, AND PROJECT GUIDANCE.
                      SUPPORTS COMPLEX CONVERSATIONS WITH ADVANCED MEMORY AND CONTEXTUAL UNDERSTANDING.
                    </p>
                    <ul className="space-y-1 sm:space-y-2 font-mono text-xs sm:text-sm">
                  ...
                  >
                    ...
                    <p className="font-mono text-sm sm:text-base leading-relaxed mb-3 sm:mb-4">
                      CREATE STUNNING, HIGH-QUALITY IMAGES AND VIDEOS WITH OUR STATE-OF-THE-ART AI GENERATORS USING
                      SIMPLE TEXT PROMPTS FOR ANY CREATIVE PROJECT.
                    </p>
                    <ul className="space-y-1 sm:space-y-2 font-mono text-xs sm:text-sm">
                      <li className="flex items-center gap-2">
                        <span className="text-primary">•</span>
                  ...
                  >
                    ...
                    <p className="font-mono text-sm sm:text-base leading-relaxed mb-3 sm:mb-4">
                      ELEVATE YOUR CREATIVE PROCESS WITH IMMERSIVE AI VOICE CHAT FEATURING REAL-TIME VOICE CONVERSATIONS
                      FOR COLLABORATIVE BRAINSTORMING AND PROJECT DEVELOPMENT.
                    </p>
                    <ul className="space-y-1 sm:space-y-2 font-mono text-xs sm:text-sm">
                      <li className="flex items-center gap-2">
                        <span className="text-primary">•</span>
